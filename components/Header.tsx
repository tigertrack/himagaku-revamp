        ...
        ></div> : user ? (
          <div className=" px-3 py-4 group relative cursor-pointer" >
            ...
            <div className="hidden group-hover:flex right-0 text-end w-40 absolute flex-col bg-gray-800 rounded-md">
              <Link href="/progress" className="px-3 py-4 cursor-pointer hover:text-teal-600 hover:rounded-md">My Progress</Link>
              <Link href="/translate" className="px-3 py-4 cursor-pointer hover:text-teal-600 ">Translate</Link>
